...
void UART_0_INIT(unsigned long baudrate)
{
    ...
    unsigned int spbrg_value = (64000000UL / (16 * baudrate)) - 1;
    TXSTA1bits.SYNC = 0;
    TXSTA1bits.TX9 = 0;
    RCSTA1bits.RX9 = 0;
    RCSTA1bits.SPEN = 1;
...
void I2C_1_INIT(unsigned long baudrate)
{
    ...
    SSP1ADD = ((64000000UL / 4) / baudrate) - 1;
...
void PWM_1_INIT(unsigned long freq, unsigned char timer)
{
    ...
    unsigned long pwmPeriod = (64000000UL / (freq * 4)) - 1;
    unsigned char divide = 0;
    if (pwmPeriod > 255) {
        pwmPeriod = (64000000UL / (freq * 4 * 16)) - 1;
        divide = 0b11;
    } else if (pwmPeriod > 63) {
        pwmPeriod = (64000000UL / (freq * 4 * 4)) - 1;
        divide = 0b10;
    } else divide = 0b00;
