...
void UART_1_INIT(unsigned long baudrate)
{
    ...
    unsigned int spbrg_value = (16000000UL / (16 * baudrate)) - 1;
    TXSTA1bits.SYNC = 0;
    TXSTA1bits.TX9 = 0;
    RCSTA1bits.RX9 = 0;
    RCSTA1bits.SPEN = 1;
...
void I2C_1_INIT(unsigned long baudrate)
{
    ...
    SSP1ADD = ((16000000UL / 4) / baudrate) - 1;
...
void I2C_2_INIT(unsigned long baudrate)
{
    ...
    SSP2ADD = ((16000000UL / 4) / baudrate) - 1;
...
void PWM_1_INIT(unsigned long freq, unsigned char timer)
{
    ...
    unsigned long pwmPeriod = (16000000UL / (freq * 4)) - 1;
    unsigned char divide = 0;
    if (pwmPeriod > 255) {
        pwmPeriod = (16000000UL / (freq * 4 * 16)) - 1;
        divide = 0b11;
    } else if (pwmPeriod > 63) {
        pwmPeriod = (16000000UL / (freq * 4 * 4)) - 1;
        divide = 0b10;
    } else divide = 0b00;
