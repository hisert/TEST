...
void LED_THREAD(unsigned char threadIndex)
{
    ...
    if (THREAD_TIME_WAIT(&timer, 950)) if (THREAD_GET_STATE() == 0x01) PIN_SET_LAT_TOGGLE('D', 1);
    if (THREAD_TIME_WAIT(&timer, 50)) if (THREAD_GET_STATE() == 0x01) PIN_SET_LAT_TOGGLE('D', 1);
