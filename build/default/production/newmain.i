...
#pragma config EBTR7 = OFF
    ...
    void TIMER_7_INIT(unsigned char ms);
    ...
    void PWM_1_INIT(unsigned long Hz);
    void PWM_1_DUTY(unsigned char duty);
    void PWM_2_INIT(unsigned long Hz);
    void PWM_2_DUTY(unsigned char duty);
    void PWM_3_INIT(unsigned long Hz);
    void PWM_3_DUTY(unsigned char duty);
    void PWM_4_INIT(unsigned long Hz);
    void PWM_4_DUTY(unsigned char duty);
    void PWM_5_INIT(unsigned long Hz);
...
void UART_0_INTERRUPT_FUNCT(unsigned char data)
{
    static unsigned char counter = 0;
    unsigned char x = data;
    if (x == '(') counter = 0;
